...
const Footer = () => {
  ...
  return (
      <footer className="relative bottom-0 flex flex-col leading-10 w-screen items-center justify-center border-b border-b-gray-800 bg-black/50 px-8 py-6">
        <h3 className='text-gray-300 text-sm'>Copyright &copy; {year}  |  <a href="/" className='bg-gradient-to-r from-blue-300 to-pink-500 bg-clip-text text-transparent opacity-80'>saishnaik.dev</a> </h3>
